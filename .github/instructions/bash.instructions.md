---
applyTo: "**/*.sh"
description: "Instructions for bash script implementation"
---

# Bash Script Instructions

These instructions define conventions for authoring Bash scripts. Scripts follow Bash 5.x conventions with strict error handling and ShellCheck compliance.
...
Allow commands to fail naturally with their native error messages. Avoid redirecting stderr to `/dev/null` unless errors are genuinely irrelevant.
